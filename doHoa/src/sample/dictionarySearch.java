...
public class dictionarySearch {
    ...
    public void insertFromFile() {
        try(Scanner scanner=new Scanner(new File("C:\\Users\\leman\\IdeaProjects\\doHoa\\src\\dictionaries.txt"))){
    ...
    public void suafile() throws FileNotFoundException, UnsupportedEncodingException {
        PrintWriter printWriter = new PrintWriter("C:\\Users\\leman\\IdeaProjects\\doHoa\\src\\dictionaries.txt", "UTF-8");
